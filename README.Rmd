...
In the example above the queue name is generated, to ensure it is unique each time the program is run. The 
...
# Queue name has been generated and published in another redis key, use "key" to get the real queue name from this key
